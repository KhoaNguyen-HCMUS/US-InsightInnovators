...
export default function MealPlanPage() {
  ...
  const handleSubstitution = (substitution: SubstitutionSuggestion) => {
    ...
    // Update the meal plan with the substitution
    ...
    updatedMealPlan.dailyPlans = updatedMealPlan.dailyPlans.map(day => ({
      ...
      meals: day.meals.map(meal => {
        if (meal.id === substitutionData.mealId) {
          return {
            ...meal,
            name: alternative.name,
            calories: meal.calories + Math.round(
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="mt-2 text-text-body">
                AI-powered meal plans tailored to your health goals and preferences
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm text-info-foreground">
              ...
              <ul className="space-y-1 text-text-body">
                ...
                <li>• Customize meals with substitutions and view your grocery list</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="bg-bg-card rounded-lg shadow-md p-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-text-body mb-6">
                Generate your first personalized meal plan based on your health profile and preferences.
              </p>
