      ...
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Chào mừng đến với Trợ lý Y khoa AI
          </h1>
          
          <p className="text-xl text-gray-600 mb-6 max-w-2xl mx-auto">
            Tôi là trợ lý AI chuyên về y khoa, sẵn sàng giúp bạn tư vấn về sức khỏe dựa trên 
            các nguồn thông tin y khoa đáng tin cậy.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickQuestions.map((question, index) => (
              <button
                key={index}
                onClick={onStartChat}
                className="p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-300 hover:shadow-lg transition-all duration-200 text-left group"
              >
        ...
        <div className="mb-8">
          <button
            onClick={onStartChat}
            className="inline-flex items-center space-x-3 px-8 py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors duration-200 text-lg font-medium shadow-lg hover:shadow-xl"
          >
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-2xl mx-auto">
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <p>
                Thông tin tôi cung cấp chỉ mang tính tham khảo và không thay thế cho việc 
                thăm khám trực tiếp với bác sĩ. Trong trường hợp khẩn cấp, hãy liên hệ ngay 
                với cơ sở y tế gần nhất.
              </p>
            </div>
          </div>
        </div>
